    ...
    public class ShoppingController : Controller
    {
        ...
        public ActionResult Payment_Successfull(string id)
        {
            try
            {
                ...
                var senderEmail = new MailAddress("andilebshange@gmail.com", "Local Brand");
                var receiverEmail = new MailAddress(User.Identity.GetUserName(), "Receiver");
                var password = "141296#Maria";
                var subject = "Payment Received";
                var body = "Payment for" + order.Order_ID + "Has been received please login to keep track of your order";
